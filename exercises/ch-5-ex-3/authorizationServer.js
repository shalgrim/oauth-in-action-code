    ...
    if (code) {
      ...
      if (code.request.client_id == clientId) {
        ...
        var token_response = {
		  ...
		  scope: code.scope.join(' ') }; // not sure why we send back scope...for refresh token ask I guess
        };
...
var getScopesFromForm = function (body) { // where do unchecked scopes get filtered out?
